...
- **Security engineering** - fuzzing, network analysis, zero-trust, zero-knowledge proofs
- **IoT & embedded systems** - single-board computers, microcontrollers, sensor-driven data collection
- **Custom development workflow optimization** - ergonomic keyboards, Neovim, Zed, dotfiles
